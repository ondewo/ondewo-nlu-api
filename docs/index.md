...
| payload | [google.protobuf.Struct](#google.protobuf.Struct) |  | Optional. This field can be used to pass custom data into the webhook associated with the agent. Following <code>key:value<code> pairs are supported in the JSON objects:
